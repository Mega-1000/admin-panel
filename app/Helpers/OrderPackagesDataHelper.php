...
{
    protected $deliveryDataTemplate = [
        ...
        'dpd-dluzyca-250x25x24-lub-200x31x30-31-5kg' => [
            'name' => 'DPD dluzyca 250x25x24 lub 200x31x30 31,5kg',
            'service_courier_name' => 'DPD',
            'delivery_courier_name' => 'DPD',
            'size_a' => 100,
            'size_b' => 43,
    ...
    {
        return $this->deliveryDataTemplate;
    }
