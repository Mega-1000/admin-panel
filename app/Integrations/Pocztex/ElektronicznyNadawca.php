...
class addShipmentResponseItemType
{
    ...
    public $numerNadania; // numerNadaniaType
    public $guid; // guidType
    public $alternatywnyNumerNadania; // string
...
class przesylkaBiznesowaPlusType
{
    ...
    public $alternatywnyNumerNadania; // alternatywnyNumerNadaniaType
}
...
{
    public $uzytkownicy; // uzytkownikType
    public $jednostkaNadrzedna; // jednostkaOrganizacyjnaType
    public $id; // int
    public $nazwa; // anonymous308
    public $opis; // anonymous309
    public $mpk; // string
}
...
{
    public $profile; // profilType
    public $domyslnaJednostka; // jednostkaOrganizacyjnaType
    public $domyslnyProfil; // profilType
    public $jednostki; // jednostkaOrganizacyjnaType
    public $id; // int
    public $nazwa; // anonymous311
    public $email; // emailType
    public $imie; // anonymous312
    public $nazwisko; // anonymous313
}
...
class getUzytkownicy
{
    public $uzytkownik; // uzytkownikType
}

class getUzytkownicyResponse
{
    public $uzytkownicy; // uzytkownikFullType
    public $error; // errorType
}
...
class rolaEnum
{
    ...
    const TRANSMIT = 'TRANSMIT';
    const MANAGE_PROFILES = 'MANAGE_PROFILES';
    const MANAGE_ORG_UNIT = 'MANAGE_ORG_UNIT';
}

class uzytkownikFullType
{
    public $karty; // kartaType
    public $dostepPoAdresieIP; // string
    public $role; // rolaEnum
    public $zablokowany; // boolean
    public $ostatnioZalogowany; // dateTime
    public $dataZmianyHasla; // dateTime
    public $liczbaDniDoWygasnieciaHasla; // int
    public $dataNieudanegoLogowania; // dateTime
    public $liczbaBlednychLogowan; // int
}
...
class alternatywnyNumerNadaniaType
{
}

class setDomyslnyProfilNadawcy
{
    public $uzytkownik; // uzytkownikType
}

class setDomyslnyProfilNadawcyResponse
{
    public $error; // errorType
}
...
class ElektronicznyNadawca extends SoapClient {
    ...
    private static $classmap = array(
        ...
        'anonymous308' => 'anonymous308',
        'anonymous309' => 'anonymous309',
        'uzytkownikType' => 'uzytkownikType',
        'anonymous311' => 'anonymous311',
        'anonymous312' => 'anonymous312',
        ...
        'getUzytkownicy' => 'getUzytkownicy',
        'getUzytkownicyResponse' => 'getUzytkownicyResponse',
        'rolaEnum' => 'rolaEnum',
        'uzytkownikFullType' => 'uzytkownikFullType',
    ...
    {
        return $this->__soapCall('addShipment', [$parameters], array(
     ...
     *
     *
     * @param getUzytkownicy $parameters
     * @return getUzytkownicyResponse
     */
    public function getUzytkownicy(getUzytkownicy $parameters)
    {
        return $this->__soapCall('getUzytkownicy', array($parameters), array(
                'uri' => 'http://e-nadawca.poczta-polska.pl',
                'soapaction' => ''
            )
        );
     ...
     *
     *
     * @param setDomyslnyProfilNadawcy $parameters
     * @return setDomyslnyProfilNadawcyResponse
     */
    public function setDomyslnyProfilNadawcy(setDomyslnyProfilNadawcy $parameters)
    {
        return $this->__soapCall('setDomyslnyProfilNadawcy', array($parameters), array(
                'uri' => 'http://e-nadawca.poczta-polska.pl',
                'soapaction' => ''
            )
        );
