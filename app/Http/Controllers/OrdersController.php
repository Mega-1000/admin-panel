...
//        WorkingEventsService::createEvent(WorkingEvents::ORDER_EDIT_EVENT, $order->id);
        ...
        $labelsButtons = Label::whereIn('id', [Label::MASTER_MARK, Label::WAREHOUSE_MARK, Label::CONSULTANT_MARK, Label::SHIPPING_MARK, 158, 157, 268])->get();
...
//            'master_order_id' => $order->id
        ...
        foreach ($request->input($orderType . 'OrderQuantity') as $id => $quantity) {
            if ($quantity != null) {
                ...
                $item->gross_selling_price_commercial_unit = (float)$data['net_selling_price_commercial_unit'][$id] * 1.23;
