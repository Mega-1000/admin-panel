...
class OrdersController extends Controller
{
    ...
    public function store(StoreOrderRequest $request)
    {
        try {
            ...
            $orderExists = $this->orderRepository->findByField('id_from_front_db', $data['id_from_front_db']);
            ...
            Log::error('Problem with create new order :' . $e->getMessage(),
                ['request' => $request->all(), 'class' => get_class($this), 'line' => __LINE__]
            );
            \Mailer::create()
                ->to('kontakt@easy-solution.pl')
