...
class AllegroApiService
{
    ...
    public function request(string $method, string $url, array $params, array $attachment = null, bool $first = true)
    {
        ...
        try {
            $headers = [
                'Authorization' => "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..zIZz2mz0oh0BVNv94mtx4ckXWZKtGWrTuMV09n_eOLf-51TV-ejLXltzYXiprQrNGpShJuoLeLi-RESkbDxi0UAYpabDDG_OP2PVlDKqbXHiiFm6SMxAPYjKVsH5mLFfhQe_7ewX5vpV4OWfP8lEf32H9FwJcNwkOpUX5fPfYtShGMoD3mfuKFQVZpeLUGl3yVPHZGUWNkOnFs8WmWNtAaa_9Yjy0Y8p2BFtdh9EadXseUUoZbmUsFXH_NmFHLfdqon0Udv36v6UGWoVj2nBLdw0GgYpEPzfMQwcfBSliE56K1XAPW-hw0WnGpUlRLEyDt-oCWzlKPlHxaGjsssUyw",
