...
class AllegroApiService
{
    ...
    public function request(string $method, string $url, array $params, array $attachment = null, bool $first = true)
    {
        ...
        var_dump($this->fetchAccessToken());
        ...
        try {
            $headers = [
                'Authorization' => "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..J6si9BiNcN3mubXrITEy852Vz_6PecU8zS7hDNUUj9xqb7oLtbcbHqUKN9SqdDaTDGzsfprnhu5CRX6DDiflL8UZlYzYaziR2SbWx1sM1xsPV6qdChcVuzMjScZfNho3W6658d_GyoqG5q70TxIof9Cx8-2b1LRRe81SuZyqB-5vBLV2WDjULDpec7_8vSFwPqKfKrq8clggEQudU5gFbRA724VaBFImFndgcxYXe8QlvLpaNhRZWrdePVS5zKvjoSoQnpGGz0EzAZcruX8JROhzxgwCOIJNu7vyMm7NPqQPTGJo4uDvh8ENw3XRlPXjyji9KLXAfXPzDWMk_c-k6A",
