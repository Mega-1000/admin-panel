...
enum OrderDatatableColumnsEnum
{
    ...
    const DEFAULT_COLUMNS = [
        ...
        ['filter' => '', 'order' => 2, 'size' => 100, 'label' => 'wyjechalo'],
        ['filter' => '', 'order' => 3, 'size' => 100, 'label' => 'nie-wyjechalo'],
        ['filter' => '', 'order' => 4, 'size' => 100, 'label' => 'production-date'],
        ['filter' => '', 'order' => 5, 'size' => 100, 'label' => 'labels-produkcja'],
        ['filter' => '', 'order' => 6, 'size' => 100, 'label' => 'labels-transport'],
        ...
        ['filter' => '', 'order' => 14, 'size' => 100, 'label' => 'bilans-oferty'],
