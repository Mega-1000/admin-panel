<div style="font-family: Arial, sans-serif; background-color: #f5f5f5; color: #333333; line-height: 1.5; margin: 0; padding: 0;">
<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
    <h1 style="color: #e67e22; text-align: center;">Oszczędź do 30zł/m3 na styropianie</h1>
    <p style="margin-bottom: 20px;">Dzień dobry,</p>
    ...
    <p style="margin-bottom: 20px;">W przypadku wszelkich pytań jesteśmy do Państwa dyspozycji pod numerem: <strong>507926027</strong> 7 dni w tygodniu od 7 do 23.</p>
