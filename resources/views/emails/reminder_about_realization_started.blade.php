...
<head>
    ...
    <title>Przypomnienie o zamówieniu - EPH Polska</title>
    <style>
        body {
...
<div class="email-container">
    ...
    <div class="content">
        <h1>Przypomnienie o zamówieniu</h1>

        <p>Szanowni Państwo,</p>

        <p>Przypominamy o zamówieniu numer: {{ $order->id }}.</p>

        <div class="highlight">
            <p>Prosimy o opłacenie zamówienia, klikając poniższy przycisk:</p>
            <a href="https://mega1000.pl/payment?token={{ $order->token }}&total={{ $order->getValue() }}" class="button">
                FAKTURA PROFORMA
            </a>
        </div>
