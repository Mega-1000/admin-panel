@if (
    ...
    <p>
        <a href="{{ route('create-represents', ['firm' => $firm->id, 'email' => \App\Entities\ChatAuctionFirm::where('token', $token)->first()?->email_of_employee ?? 'Nie wiadomo']) }}">KLIKNIJ LINK ABY JE PODAĆ</a>
    </p>
    <p>
