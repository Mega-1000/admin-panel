<body>
    <p>PW zwiazku z wydaniem towaru do panstwa ze zlecenia nr {{ $orderId }} informujemy iz bedziemy wystawiac w najblizszym czasie fakture i wysylac ja panstwu na e maila.</p>
    ...
    <br/>
    <a href="http://mega1000.pro-linuxpl.com/customer/{{ $orderId }}/confirmation/{{$invoiceId}}">POTWIERDZ DANE DO FAKTURY</a>
</body>
