...
@section('app-header')
    <h1 class="page-title">
        <i class="voyager-pen"></i> @lang('tasks.edit')
...
@section('table')
    ...
    @endif
    <form action="{{ action('TasksController@update', ['id' => $task->id]) }}" method="post">
        {{ method_field('put') }}
        {{ csrf_field() }}
        <div class="statuses-general" id="general">
            ...
            <div class="form-group">
                ...
                <input class="form-control default-date-time-picker-now" name="date_start" type="text"
                       value="{{$task->taskTime->date_start}}">
            </div>
            <div class="form-group">
                <label for="date_end">@lang('tasks.form.date_end')</label>
                <input class="form-control default-date-time-picker-now" name="date_end" type="text"
                       value="{{$task->taskTime->date_end}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="consultant_value" id="consultant_value" class="form-control" value="{{$task->taskSalaryDetail !== null ? $task->taskSalaryDetail->consultant_value : ''}}">
            </div>
            <div class="form-group">
                ...
                <textarea rows="5" cols="40" type="text" name="consultant_notice" id="consultant_notice"
                          class="form-control">{{$task->taskSalaryDetail !== null ? $task->taskSalaryDetail->consultant_notice : ''}}</textarea>
            </div>
            <div class="form-group">
                <label for="warehouse_value">@lang('tasks.form.warehouse_value')</label>
                <input type="text" name="warehouse_value" id="warehouse_value" class="form-control" value="{{$task->taskSalaryDetail !== null ? $task->taskSalaryDetail->warehouse_value : ''}}">
            </div>
            <div class="form-group">
                ...
                <textarea rows="5" cols="40" type="text" name="warehouse_notice" id="warehouse_notice"
                          class="form-control">{{$task->taskSalaryDetail !== null ? $task->taskSalaryDetail->warehouse_notice : ''}}</textarea>
            </div>
        </div>
