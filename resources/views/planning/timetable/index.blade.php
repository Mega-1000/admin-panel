        ...
        function renderCalendar(minTime = "07:00:00", maxTime = "18:00:00", slot = "0:05") {
            ...
            let calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventDrop: function (info) {
                    ...
                    let dateTime = firstDate.getUTCFullYear() + '-' + ('0' + (firstDate.getUTCMonth() + 1)).slice(-2) + '-' + firstDate.getUTCDate() + ' ' + firstDate.getHours() + ':' + startMinutes;
                ...
                eventClick: function (info) {
                    ...
                    function prepareOrderList(item) {
                        ...
                        const route = "{{ route('orders.edit', ['order_id' => '%%']) }}";
