                                    ...
                                    {{--@foreach($order->items as $item)--}}
                                        ...
                                        {{--@else--}}
                                            {{--<tr class="id row-{{$item->id}}" id="id[{{$item->id}}]">--}}
                                                {{--<td colspan="3"><h4><img src="{!! str_replace('C:\\z\\', 'https://mega1000.pl/', $item->product->url) !!}" style="width: 179px; height: 130px;"><strong>{{ $loop->iteration }}. </strong>{{ $item->product->name }} (symbol: {{ $item->product->symbol }}) </h4></td>--}}
                                                {{--<td><input--}}
