                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center">
                            ...
                            <span class="product-text cursor-pointer" data-product-id="{{ $product->id }}">
                                ...
                                Ilość m3: {{ round($product->quantity * $product->packing->numbers_of_basic_commercial_units_in_pack, 2) }} <br> {{$product->packing->numbers_of_basic_commercial_units_in_pack}}
