...
<script>
    ...
    // Origin zip code
    var originZipCode = "{{ \App\Helpers\LocationHelper::nearestWarehouse($chat_auction_firm->chatAuction->chat->order->customer, $chat_auction_firm->firm)->address->zip_code }}";
