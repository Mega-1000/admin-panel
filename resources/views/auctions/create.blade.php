...
<body>
    <form class="form-group-default m-6" action="{{ route('auctions.store', ['chat' => $chat->id, 'backUrl' => URL::previous()]) }}" method="post">
        ...
        <div class="output-container">
            <input type="text" id="price-input" value="50" name="price" placeholder="Cena" disabled>
            <input type="text" id="quality-input" value="50" name="quality" placeholder="Jakość" disabled>
        </div>
