<div class="modal fade" tabindex="-1" id="stockQuantityLow" role="dialog">
...
<div class="modal fade" tabindex="-1" id="stockPositionQuantityLow" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
...
<div class="modal fade" tabindex="-1" id="stockPositionMissing" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"
