            ...
            <td>
                ...
                @else
                    ...
                    @if(auth()->id())
                        ...
                        {{ App\Entities\ChatAuctionFirm::where('firm_id', App\Entities\Firm::where('symbol', $symbol)->where('chat_auction_id', $order->chat->auctions->first()->id)->first()->id)->first()->token }}">
                            Dodaj cenę jako ta firma
                        </a>
                    @endif
                @endif
