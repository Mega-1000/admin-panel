<confirmation-without-data.blade.php>
<head>
                ...
                <div class="order-messages" id="order-messages">
                    <div class="panel panel-bordered">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="firstname">Imię</label>
                                <input type="text" class="form-control" name="subiekt-firstname" disabled>
                            </div>
                            <div class="form-group">
                                <label for="lastname">Nazwisko</label>
                                <input type="text" class="form-control" name="subiekt-lastname" disabled>
                            </div>
                            <div class="form-group">
                                <label for="firmname">Nazwa firmy</label>
                                <input type="text" class="form-control" name="subiekt-firmname" disabled>
                            </div>
                            <div class="form-group">
                                <label for="nip">NIP</label>
                                <input type="text" class="form-control" name="subiekt-nip" disabled>
                            </div>
                            <div class="form-group">
                                <label for="phone">Numer telefonu</label>
                                <input type="text" class="form-control" name="subiekt-phone" disabled>
                            </div>
                            <div class="form-group">
                                <label for="address">Ulica</label>
                                <input type="text" class="form-control" name="subiekt-address" disabled>
                            </div>
                            <div class="form-group">
                                <label for="flat_number">Numer domu/mieszkania</label>
                                <input type="text" class="form-control" name="subiekt-flat-number" disabled>
                            </div>
                            <div class="form-group">
                                <label for="city">Miasto</label>
                                <input type="text" class="form-control" name="subiekt-city" disabled>
                            </div>
                            <div class="form-group">
                                <label for="postal_code">Kod pocztowy</label>
                                <input type="text" class="form-control" name="subiekt-postal-code" disabled>
                            </div>
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input type="text" class="form-control" name="subiekt-email" disabled>
                            </div>
                        </div>
                    </div>
                </div>
