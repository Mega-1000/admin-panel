...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('orders')->name('api.orders.')->group(function () {
        ...
        Route::post('{orderId}/update-items', 'Api\OrdersController@updateOrderItems')->name('update-items');
    });
...
Route::post('oauth/token/from-user-code', 'Api\AutheticationController@loginByCode')->name('api.authenticate.login-by-code');
...
// Moved to web routes (price-list.*) — no longer public API
